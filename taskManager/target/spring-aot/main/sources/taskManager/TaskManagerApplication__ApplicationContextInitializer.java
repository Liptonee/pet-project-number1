 ...
 */
@Generated
public class TaskManagerApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TaskManagerApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TaskManagerApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "taskManager.web.security.SecurityConfig");
