...
/**
 * Bean definitions for {@link ProjectRepository}.
 */
@Generated
public class ProjectRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'projectRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getProjectRepositoryInstanceSupplier(
      ) {
  ...
  public static BeanDefinition getProjectRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ProjectRepository.class, ProjectEntity.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "taskManager.database.repositories.ProjectRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ProjectRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new taskManager.database.repositories.ProjectRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getProjectRepositoryInstanceSupplier();
