...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("taskManager.database.entities.CommentEntity", "taskManager.database.entities.ProjectEntity", "taskManager.database.entities.ProjectTasksEntity", "taskManager.database.entities.ProjectUsersEntity", "taskManager.database.entities.TaskEntity", "taskManager.database.entities.UserEntity", "taskManager.database.entities.UserTasksEntity");
